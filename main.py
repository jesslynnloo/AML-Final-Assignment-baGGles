...
def main():
    ...
    video_path = 'C:\\Users\\Jesslynn\\Desktop\\Master\\Sem 1\\WOA7015 Advanced Machine Learning\\Assignments\\Final Assignment\\Arm Flapping SSBD (ML Class)\\3.mp4'
    ...
    model_path = '1_layer_CE_30_epochs_0.001.pth'
